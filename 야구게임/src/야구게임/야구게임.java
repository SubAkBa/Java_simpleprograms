						...
						public void actionPerformed(ActionEvent ae)
						{
							...
							for(int i=0;i<4;i++)
							{
								for(int j=0;j<4;j++)
								{
									...
									{
										while(Integer.toString(rannum).equals(answernum[0]) || Integer.toString(rannum).equals(answernum[1]) || 
												Integer.toString(rannum).equals(answernum[2]) || Integer.toString(rannum).equals(answernum[3]))
											rannum = ran.nextInt(10);
