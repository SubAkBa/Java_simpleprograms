...
public class 점수관리프로그램 {
	public static void main(String[] args) {
		...
		JScrollPane jsp = new JScrollPane(jt, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
		...
		btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				int avg = (Integer.parseInt(jtf[1].getText()) + Integer.parseInt(jtf[2].getText())
						+ Integer.parseInt(jtf[3].getText())) / 3;
				String[] sa = { jtf[0].getText(), jtf[1].getText(), jtf[2].getText(), jtf[3].getText(),
